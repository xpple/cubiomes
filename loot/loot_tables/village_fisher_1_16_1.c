...
#include "village_fisher_1_16_1.h"
...
static char* item_names[7] = {"minecraft:emerald", "minecraft:cod", "minecraft:salmon", "minecraft:water_bucket", "minecraft:barrel", "minecraft:wheat_seeds", "minecraft:coal"};
static int global_item_ids[7] = {ITEM_EMERALD, ITEM_COD, ITEM_SALMON, ITEM_WATER_BUCKET, ITEM_BARREL, ITEM_WHEAT_SEEDS, ITEM_COAL};

static int precomputed_loot__0[11] = {0, 1, 1, 2, 3, 4, 5, 5, 5, 6, 6};
static int entry_to_item__0[7] = {0, 1, 2, 3, 4, 5, 6};
static int entry_functions_count__0[7] = {0, 1, 1, 1, 1, 1, 1};
static int entry_functions_index__0[7] = {0, 0, 1, 2, 3, 4, 5};
static LootFunction loot_functions__0[6];
static const LootPool village_fisher_1_16_1__0 = {
    .min_rolls = 1,
    .max_rolls = 5,
...
static LootPool loot_pools[1] = {village_fisher_1_16_1__0};
