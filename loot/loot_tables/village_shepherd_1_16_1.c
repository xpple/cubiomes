...
#include "village_shepherd_1_16_1.h"
...
static char* item_names[8] = {"minecraft:white_wool", "minecraft:black_wool", "minecraft:gray_wool", "minecraft:brown_wool", "minecraft:light_gray_wool", "minecraft:emerald", "minecraft:shears", "minecraft:wheat"};
static int global_item_ids[8] = {ITEM_WHITE_WOOL, ITEM_BLACK_WOOL, ITEM_GRAY_WOOL, ITEM_BROWN_WOOL, ITEM_LIGHT_GRAY_WOOL, ITEM_EMERALD, ITEM_SHEARS, ITEM_WHEAT};

static int precomputed_loot__0[23] = {0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 3, 3, 4, 4, 5, 6, 7, 7, 7, 7, 7, 7};
static int entry_to_item__0[8] = {0, 1, 2, 3, 4, 5, 6, 7};
static int entry_functions_count__0[8] = {1, 1, 1, 1, 1, 0, 0, 1};
static int entry_functions_index__0[8] = {0, 1, 2, 3, 4, 5, 5, 5};
static LootFunction loot_functions__0[6];
static const LootPool village_shepherd_1_16_1__0 = {
    .min_rolls = 1,
    .max_rolls = 5,
...
static LootPool loot_pools[1] = {village_shepherd_1_16_1__0};
...
static void create_loot_functions(int version) {
    ...
    create_set_count(&(loot_pool__0->loot_functions[0]), 1, 8);
    ...
    create_set_count(&(loot_pool__0->loot_functions[5]), 1, 6);
}
