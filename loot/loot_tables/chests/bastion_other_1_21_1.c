...
static void create_loot_functions() {
    ...
    create_enchant_randomly_tag(&(loot_pool__0->loot_functions[1]), MC_1_21_1, get_item_type("minecraft:diamond_pickaxe"), "#minecraft:on_random_loot", 0);
    create_set_count(&(loot_pool__0->loot_functions[2]), 1, 1);
    create_skip_calls(&(loot_pool__0->loot_functions[3]), 1);
    create_enchant_randomly_tag(&(loot_pool__0->loot_functions[4]), MC_1_21_1, get_item_type("minecraft:crossbow"), "#minecraft:on_random_loot", 0);
    ...
    create_enchant_randomly_tag(&(loot_pool__1->loot_functions[2]), MC_1_21_1, get_item_type("minecraft:iron_sword"), "#minecraft:on_random_loot", 0);
    ...
    create_enchant_randomly_tag(&(loot_pool__1->loot_functions[7]), MC_1_21_1, get_item_type("minecraft:golden_axe"), "#minecraft:on_random_loot", 0);
