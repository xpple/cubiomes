...
#include "stronghold_corridor_1_20.h"
...
static const LootPool stronghold_corridor_1_20__0 = {
    .min_rolls = 2,
    .max_rolls = 3,
...
static int entry_to_item__1[2] = {-1, 20};
...
static const LootPool stronghold_corridor_1_20__1 = {
    .min_rolls = 1,
    .max_rolls = 1,
...
static LootPool loot_pools[2] = {stronghold_corridor_1_20__0, stronghold_corridor_1_20__1};
...
static void create_loot_functions(int version) {
    ...
    create_enchant_with_levels(&(loot_pool__0->loot_functions[6]), version, "minecraft:book", get_item_type("minecraft:book"), 30, 30, 1);
    LootPool* loot_pool__1 = &(context.loot_pools[1]);
}

LootTableContext* init_stronghold_corridor_1_20(int version) {
