...
#include "bastion_other_1_16_5.h"
...
void init_bastion_other_1_16_5(LootTableContext* context) {
    ...
    static LootPool bastion_other_1_16_5__0 = {
        .min_rolls = 1,
        .max_rolls = 1,
    ...
    static LootPool bastion_other_1_16_5__1 = {
        .min_rolls = 2,
        .max_rolls = 2,
        .roll_count_function = roll_count_constant,
        .entry_count = 14,
    ...
    static LootPool bastion_other_1_16_5__2 = {
        .min_rolls = 3,
        .max_rolls = 4,
    ...
    context->version = MC_1_16_5;
    context->item_count = 35;
    ...
    context->loot_pools[0] = bastion_other_1_16_5__0;
    context->loot_pools[1] = bastion_other_1_16_5__1;
    context->loot_pools[2] = bastion_other_1_16_5__2;
    ...
    create_enchant_randomly(&(loot_pool__0->loot_functions[1]), MC_1_16_5, get_item_type("minecraft:diamond_pickaxe"), 1);
    create_set_count(&(loot_pool__0->loot_functions[2]), 1, 1);
    create_skip_calls(&(loot_pool__0->loot_functions[3]), 1);
    create_enchant_randomly(&(loot_pool__0->loot_functions[4]), MC_1_16_5, get_item_type("minecraft:crossbow"), 1);
    ...
    create_enchant_randomly(&(loot_pool__1->loot_functions[2]), MC_1_16_5, get_item_type("minecraft:iron_sword"), 1);
    ...
    create_enchant_randomly(&(loot_pool__1->loot_functions[7]), MC_1_16_5, get_item_type("minecraft:golden_axe"), 1);
