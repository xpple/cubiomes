...
public class SeaLevelColumnNoiseBeta {
    ...
    private static final long contASample$OFFSET = $LAYOUT.byteOffset(groupElement("contASample"));
    ...
    private static final long contBSample$OFFSET = $LAYOUT.byteOffset(groupElement("contBSample"));
    ...
    private static final long minSample$OFFSET = $LAYOUT.byteOffset(groupElement("minSample"));
    ...
    private static final long maxSample$OFFSET = $LAYOUT.byteOffset(groupElement("maxSample"));
    ...
    private static final long mainSample$OFFSET = $LAYOUT.byteOffset(groupElement("mainSample"));
