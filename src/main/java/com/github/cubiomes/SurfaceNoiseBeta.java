...
public class SurfaceNoiseBeta {
    ...
    private static final long octcontA$OFFSET = $LAYOUT.byteOffset(groupElement("octcontA"));
    ...
    private static final long octcontB$OFFSET = $LAYOUT.byteOffset(groupElement("octcontB"));
