...
public class SplineStack {
    ...
    private static final long fstack$OFFSET = $LAYOUT.byteOffset(groupElement("fstack"));
    ...
    private static final long flen$OFFSET = $LAYOUT.byteOffset(groupElement("flen"));
