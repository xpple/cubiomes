...
public class OctaveNoise {
    ...
    private static final long octcnt$OFFSET = $LAYOUT.byteOffset(groupElement("octcnt"));
    ...
    private static final long octaves$OFFSET = $LAYOUT.byteOffset(groupElement("octaves"));
