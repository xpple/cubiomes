...
public class Xoroshiro {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Cubiomes.C_LONG.withName("lo"),
        Cubiomes.C_LONG.withName("hi")
    ).withName("Xoroshiro");
    ...
    private static final long lo$OFFSET = $LAYOUT.byteOffset(groupElement("lo"));
    ...
    private static final long hi$OFFSET = $LAYOUT.byteOffset(groupElement("hi"));
