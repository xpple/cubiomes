...
public class Spline {
    ...
    private static final long typ$OFFSET = $LAYOUT.byteOffset(groupElement("typ"));
    ...
    private static final long loc$OFFSET = $LAYOUT.byteOffset(groupElement("loc"));
    ...
    private static final long der$OFFSET = $LAYOUT.byteOffset(groupElement("der"));
