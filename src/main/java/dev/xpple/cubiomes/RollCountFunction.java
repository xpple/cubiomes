...
public class RollCountFunction {
    ...
    private static final MethodHandle UP$MH = Cubiomes.upcallHandle(RollCountFunction.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(RollCountFunction.Function fi, Arena arena) {
