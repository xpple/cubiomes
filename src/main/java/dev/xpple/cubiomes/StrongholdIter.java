...
public class StrongholdIter {
    ...
    private static final long nextapprox$OFFSET = $LAYOUT.byteOffset(groupElement("nextapprox"));
    ...
    private static final long ringnum$OFFSET = $LAYOUT.byteOffset(groupElement("ringnum"));
    ...
    private static final long ringmax$OFFSET = $LAYOUT.byteOffset(groupElement("ringmax"));
    ...
    private static final long ringidx$OFFSET = $LAYOUT.byteOffset(groupElement("ringidx"));
    ...
    private static final long angle$OFFSET = $LAYOUT.byteOffset(groupElement("angle"));
    ...
    private static final long dist$OFFSET = $LAYOUT.byteOffset(groupElement("dist"));
    ...
    private static final long rnds$OFFSET = $LAYOUT.byteOffset(groupElement("rnds"));
