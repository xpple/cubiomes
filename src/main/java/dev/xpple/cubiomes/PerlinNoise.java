...
public class PerlinNoise {
    ...
    private static final long amplitude$OFFSET = $LAYOUT.byteOffset(groupElement("amplitude"));
    ...
    private static final long lacunarity$OFFSET = $LAYOUT.byteOffset(groupElement("lacunarity"));
    ...
    private static final long d2$OFFSET = $LAYOUT.byteOffset(groupElement("d2"));
    ...
    private static final long t2$OFFSET = $LAYOUT.byteOffset(groupElement("t2"));
